...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Carrier Shipment Pickup End Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link MATSimFreightMetamodel.freightContrib.events.impl.CarrierShipmentPickupEndEventImpl#getCapacityDemand <em>Capacity Demand</em>}</li>
 *   <li>{@link MATSimFreightMetamodel.freightContrib.events.impl.CarrierShipmentPickupEndEventImpl#getPickupDuration <em>Pickup Duration</em>}</li>
 *   <li>{@link MATSimFreightMetamodel.freightContrib.events.impl.CarrierShipmentPickupEndEventImpl#getCarrierShipment <em>Carrier Shipment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CarrierShipmentPickupEndEventImpl extends CarrierEventImpl implements CarrierShipmentPickupEndEvent {
	/**
	 ...
	 * @generated
	 */
	protected CarrierShipmentPickupEndEventImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EventsPackage.Literals.CARRIER_SHIPMENT_PICKUP_END_EVENT;
	}
	...
	public void setCapacityDemand(int newCapacityDemand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.CARRIER_SHIPMENT_PICKUP_END_EVENT__CAPACITY_DEMAND, oldCapacityDemand, capacityDemand));
	}
	...
	public void setPickupDuration(double newPickupDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.CARRIER_SHIPMENT_PICKUP_END_EVENT__PICKUP_DURATION, oldPickupDuration, pickupDuration));
	}
	...
	public CarrierShipment getCarrierShipment() {
		if (carrierShipment != null && carrierShipment.eIsProxy()) {
			...
			if (carrierShipment != oldCarrierShipment) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EventsPackage.CARRIER_SHIPMENT_PICKUP_END_EVENT__CARRIER_SHIPMENT, oldCarrierShipment, carrierShipment));
			}
		}
	...
	public void setCarrierShipment(CarrierShipment newCarrierShipment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.CARRIER_SHIPMENT_PICKUP_END_EVENT__CARRIER_SHIPMENT, oldCarrierShipment, carrierShipment));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EventsPackage.CARRIER_SHIPMENT_PICKUP_END_EVENT__CAPACITY_DEMAND:
				return getCapacityDemand();
			case EventsPackage.CARRIER_SHIPMENT_PICKUP_END_EVENT__PICKUP_DURATION:
				return getPickupDuration();
			case EventsPackage.CARRIER_SHIPMENT_PICKUP_END_EVENT__CARRIER_SHIPMENT:
...
} //CarrierShipmentPickupEndEventImpl
