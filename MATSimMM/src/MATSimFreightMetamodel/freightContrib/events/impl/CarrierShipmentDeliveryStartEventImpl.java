...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Carrier Shipment Delivery Start Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link MATSimFreightMetamodel.freightContrib.events.impl.CarrierShipmentDeliveryStartEventImpl#getCarrierShipment <em>Carrier Shipment</em>}</li>
 *   <li>{@link MATSimFreightMetamodel.freightContrib.events.impl.CarrierShipmentDeliveryStartEventImpl#getDeliveryDuration <em>Delivery Duration</em>}</li>
 *   <li>{@link MATSimFreightMetamodel.freightContrib.events.impl.CarrierShipmentDeliveryStartEventImpl#getCapacityDemand <em>Capacity Demand</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CarrierShipmentDeliveryStartEventImpl extends CarrierEventImpl implements CarrierShipmentDeliveryStartEvent {
	/**
	 ...
	 * @generated
	 */
	protected CarrierShipmentDeliveryStartEventImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EventsPackage.Literals.CARRIER_SHIPMENT_DELIVERY_START_EVENT;
	}
		...
		if (carrierShipment != null && carrierShipment.eIsProxy()) {
			...
			if (carrierShipment != oldCarrierShipment) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EventsPackage.CARRIER_SHIPMENT_DELIVERY_START_EVENT__CARRIER_SHIPMENT, oldCarrierShipment, carrierShipment));
			}
		}
	...
	public void setCarrierShipment(CarrierShipment newCarrierShipment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.CARRIER_SHIPMENT_DELIVERY_START_EVENT__CARRIER_SHIPMENT, oldCarrierShipment, carrierShipment));
	}
	...
	public void setDeliveryDuration(double newDeliveryDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.CARRIER_SHIPMENT_DELIVERY_START_EVENT__DELIVERY_DURATION, oldDeliveryDuration, deliveryDuration));
	}
	...
	public void setCapacityDemand(int newCapacityDemand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.CARRIER_SHIPMENT_DELIVERY_START_EVENT__CAPACITY_DEMAND, oldCapacityDemand, capacityDemand));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EventsPackage.CARRIER_SHIPMENT_DELIVERY_START_EVENT__CARRIER_SHIPMENT:
				if (resolve) return getCarrierShipment();
				return basicGetCarrierShipment();
			case EventsPackage.CARRIER_SHIPMENT_DELIVERY_START_EVENT__DELIVERY_DURATION:
				return getDeliveryDuration();
			case EventsPackage.CARRIER_SHIPMENT_DELIVERY_START_EVENT__CAPACITY_DEMAND:
...
} //CarrierShipmentDeliveryStartEventImpl
