...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Carrier Service End Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link MATSimFreightMetamodel.freightContrib.events.impl.CarrierServiceEndEventImpl#getCarrierService <em>Carrier Service</em>}</li>
 *   <li>{@link MATSimFreightMetamodel.freightContrib.events.impl.CarrierServiceEndEventImpl#getCapacityDemand <em>Capacity Demand</em>}</li>
 *   <li>{@link MATSimFreightMetamodel.freightContrib.events.impl.CarrierServiceEndEventImpl#getServiceDuration <em>Service Duration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CarrierServiceEndEventImpl extends CarrierEventImpl implements CarrierServiceEndEvent {
	/**
	 ...
	 * @generated
	 */
	protected CarrierServiceEndEventImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EventsPackage.Literals.CARRIER_SERVICE_END_EVENT;
	}
		...
		if (carrierService != null && carrierService.eIsProxy()) {
			...
			if (carrierService != oldCarrierService) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EventsPackage.CARRIER_SERVICE_END_EVENT__CARRIER_SERVICE, oldCarrierService, carrierService));
			}
		}
	...
	public void setCarrierService(CarrierService newCarrierService) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.CARRIER_SERVICE_END_EVENT__CARRIER_SERVICE, oldCarrierService, carrierService));
	}
	...
	public void setCapacityDemand(int newCapacityDemand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.CARRIER_SERVICE_END_EVENT__CAPACITY_DEMAND, oldCapacityDemand, capacityDemand));
	}
	...
	public void setServiceDuration(double newServiceDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.CARRIER_SERVICE_END_EVENT__SERVICE_DURATION, oldServiceDuration, serviceDuration));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EventsPackage.CARRIER_SERVICE_END_EVENT__CARRIER_SERVICE:
				if (resolve) return getCarrierService();
				return basicGetCarrierService();
			case EventsPackage.CARRIER_SERVICE_END_EVENT__CAPACITY_DEMAND:
				return getCapacityDemand();
			case EventsPackage.CARRIER_SERVICE_END_EVENT__SERVICE_DURATION:
