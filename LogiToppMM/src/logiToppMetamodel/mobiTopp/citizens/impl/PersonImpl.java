 ...
 * </p>
 * <ul>
 *   <li>{@link logiToppMetamodel.mobiTopp.citizens.impl.PersonImpl#getHousehold <em>Household</em>}</li>
 *   <li>{@link logiToppMetamodel.mobiTopp.citizens.impl.PersonImpl#getAge <em>Age</em>}</li>
 *   <li>{@link logiToppMetamodel.mobiTopp.citizens.impl.PersonImpl#getGender <em>Gender</em>}</li>
 *   <li>{@link logiToppMetamodel.mobiTopp.citizens.impl.PersonImpl#getEmployment <em>Employment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PersonImpl extends EntityImpl implements Person {
	...
	protected EClass eStaticClass() {
		return CitizensPackage.Literals.PERSON;
	}
	...
	public Household getHousehold() {
		if (eContainerFeatureID() != CitizensPackage.PERSON__HOUSEHOLD) return null;
	...
	public NotificationChain basicSetHousehold(Household newHousehold, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newHousehold, CitizensPackage.PERSON__HOUSEHOLD, msgs);
		return msgs;
	}
	...
	public void setHousehold(Household newHousehold) {
		if (newHousehold != eInternalContainer() || (eContainerFeatureID() != CitizensPackage.PERSON__HOUSEHOLD && newHousehold != null)) {
			...
			if (newHousehold != null)
				msgs = ((InternalEObject)newHousehold).eInverseAdd(this, CitizensPackage.HOUSEHOLD__MEMBERS, Household.class, msgs);
			msgs = basicSetHousehold(newHousehold, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CitizensPackage.PERSON__HOUSEHOLD, newHousehold, newHousehold));
	}
	...
	public void setAge(int newAge) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CitizensPackage.PERSON__AGE, oldAge, age));
	}
	...
	public void setGender(Gender newGender) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CitizensPackage.PERSON__GENDER, oldGender, gender));
	}
	...
	public void setEmployment(Employment newEmployment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CitizensPackage.PERSON__EMPLOYMENT, oldEmployment, employment));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CitizensPackage.PERSON__HOUSEHOLD:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case CitizensPackage.PERSON__HOUSEHOLD:
				return eInternalContainer().eInverseRemove(this, CitizensPackage.HOUSEHOLD__MEMBERS, Household.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CitizensPackage.PERSON__HOUSEHOLD:
				return getHousehold();
			case CitizensPackage.PERSON__AGE:
				return getAge();
			case CitizensPackage.PERSON__GENDER:
				return getGender();
			case CitizensPackage.PERSON__EMPLOYMENT:
