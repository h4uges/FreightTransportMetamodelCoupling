 ...
 * @generated
 */
public class CitizensPackageImpl extends EPackageImpl implements CitizensPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see logiToppMetamodel.mobiTopp.citizens.CitizensPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private CitizensPackageImpl() {
		super(eNS_URI, CitizensFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link CitizensPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static CitizensPackage init() {
		if (isInited) return (CitizensPackage)EPackage.Registry.INSTANCE.getEPackage(CitizensPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredCitizensPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		CitizensPackageImpl theCitizensPackage = registeredCitizensPackage instanceof CitizensPackageImpl ? (CitizensPackageImpl)registeredCitizensPackage : new CitizensPackageImpl();
		...
		theCitizensPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(CitizensPackage.eNS_URI, theCitizensPackage);
		return theCitizensPackage;
	}
	 ...
	 */
	@Override
	public CitizensFactory getCitizensFactory() {
		return (CitizensFactory)getEFactoryInstance();
	}
