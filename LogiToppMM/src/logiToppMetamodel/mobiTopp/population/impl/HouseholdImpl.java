 ...
 * </p>
 * <ul>
 *   <li>{@link logiToppMetamodel.mobiTopp.population.impl.HouseholdImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link logiToppMetamodel.mobiTopp.population.impl.HouseholdImpl#getMembers <em>Members</em>}</li>
 *   <li>{@link logiToppMetamodel.mobiTopp.population.impl.HouseholdImpl#getZone <em>Zone</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HouseholdImpl extends EntityImpl implements Household {
	...
	public EList<Person> getMembers() {
		if (members == null) {
			members = new EObjectContainmentWithInverseEList<Person>(Person.class, this, PopulationPackage.HOUSEHOLD__MEMBERS, PopulationPackage.PERSON__HOUSEHOLD);
		}
		return members;
	}
	...
	public Zone getZone() {
		if (zone != null && zone.eIsProxy()) {
			...
			if (zone != oldZone) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PopulationPackage.HOUSEHOLD__ZONE, oldZone, zone));
			}
		}
		return zone;
	}
	...
	public NotificationChain basicSetZone(Zone newZone, NotificationChain msgs) {
		...
		zone = newZone;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PopulationPackage.HOUSEHOLD__ZONE, oldZone, newZone);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setZone(Zone newZone) {
		if (newZone != zone) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PopulationPackage.HOUSEHOLD__ZONE, newZone, newZone));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PopulationPackage.HOUSEHOLD__MEMBERS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getMembers()).basicAdd(otherEnd, msgs);
			case PopulationPackage.HOUSEHOLD__ZONE:
				if (zone != null)
					msgs = ((InternalEObject)zone).eInverseRemove(this, NetworkPackage.ZONE__HOUSEHOLDS, Zone.class, msgs);
