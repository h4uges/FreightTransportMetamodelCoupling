 ...
 * </p>
 * <ul>
 *   <li>{@link logiToppMetamodel.base.impl.NamedEntityImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NamedEntityImpl extends EntityImpl implements NamedEntity {
	...
	protected EClass eStaticClass() {
		return BasePackage.Literals.NAMED_ENTITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.NAMED_ENTITY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BasePackage.NAMED_ENTITY__NAME:
				return getName();
		}
