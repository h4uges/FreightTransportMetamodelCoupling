 ...
 * </p>
 * <ul>
 *   <li>{@link logiToppMetamodel.base.impl.TimeImpl#getSeconds <em>Seconds</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeImpl extends MinimalEObjectImpl.Container implements Time {
	...
	protected EClass eStaticClass() {
		return BasePackage.Literals.TIME;
	}
	...
	public void setSeconds(int newSeconds) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.TIME__SECONDS, oldSeconds, seconds));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BasePackage.TIME__SECONDS:
				return getSeconds();
		}
