...
import logiToppMetamodel.logiTopp.distribution.chains.ChainsFactory;
...
public class ChainsPackageImpl extends EPackageImpl implements ChainsPackage {
	 ...
	 * @generated
	 */
	private EClass transportChainEClass = null;
	 ...
	 * @generated
	 */
	private EClass timedTransportChainEClass = null;
	 ...
	 * @generated
	 */
	private EClass hubToDepartureEClass = null;
	 ...
	 * @generated
	 */
	private EClass hubToDurationEClass = null;
	 ...
	 * @see logiToppMetamodel.logiTopp.distribution.chains.ChainsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EClass getTransportChain() {
		return transportChainEClass;
	}
	 ...
	 */
	@Override
	public EReference getTransportChain_Hubs() {
		return (EReference)transportChainEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getTransportChain_DeliveryDirection() {
		return (EAttribute)transportChainEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EClass getTimedTransportChain() {
		return timedTransportChainEClass;
	}
	 ...
	 */
	@Override
	public EReference getTimedTransportChain_Departures() {
		return (EReference)timedTransportChainEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getTimedTransportChain_Durations() {
		return (EReference)timedTransportChainEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EClass getHubToDeparture() {
		return hubToDepartureEClass;
	}
	 ...
	 */
	@Override
	public EReference getHubToDeparture_Hub() {
		return (EReference)hubToDepartureEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getHubToDeparture_Depature() {
		return (EReference)hubToDepartureEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EClass getHubToDuration() {
		return hubToDurationEClass;
	}
	 ...
	 */
	@Override
	public EReference getHubToDuration_Hub() {
		return (EReference)hubToDurationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getHubToDuration_Duration() {
		return (EAttribute)hubToDurationEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		transportChainEClass = createEClass(TRANSPORT_CHAIN);
		createEReference(transportChainEClass, TRANSPORT_CHAIN__HUBS);
		createEAttribute(transportChainEClass, TRANSPORT_CHAIN__DELIVERY_DIRECTION);

		timedTransportChainEClass = createEClass(TIMED_TRANSPORT_CHAIN);
		createEReference(timedTransportChainEClass, TIMED_TRANSPORT_CHAIN__DEPARTURES);
		createEReference(timedTransportChainEClass, TIMED_TRANSPORT_CHAIN__DURATIONS);

		hubToDepartureEClass = createEClass(HUB_TO_DEPARTURE);
		createEReference(hubToDepartureEClass, HUB_TO_DEPARTURE__HUB);
		createEReference(hubToDepartureEClass, HUB_TO_DEPARTURE__DEPATURE);

		hubToDurationEClass = createEClass(HUB_TO_DURATION);
		createEReference(hubToDurationEClass, HUB_TO_DURATION__HUB);
		createEAttribute(hubToDurationEClass, HUB_TO_DURATION__DURATION);
	}
	...
	public void initializePackageContents() {
		...
		timedTransportChainEClass.getESuperTypes().add(this.getTransportChain());

		// Initialize classes, features, and operations; add parameters
		initEClass(transportChainEClass, TransportChain.class, "TransportChain", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTransportChain_Hubs(), theDistributionPackage.getDistributionCenter(), null, "hubs", null, 0, -1, TransportChain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTransportChain_DeliveryDirection(), theXMLTypePackage.getBoolean(), "deliveryDirection", "true", 1, 1, TransportChain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(timedTransportChainEClass, TimedTransportChain.class, "TimedTransportChain", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTimedTransportChain_Departures(), this.getHubToDeparture(), null, "departures", null, 0, -1, TimedTransportChain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTimedTransportChain_Durations(), this.getHubToDuration(), null, "durations", null, 0, -1, TimedTransportChain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(hubToDepartureEClass, HubToDeparture.class, "HubToDeparture", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getHubToDeparture_Hub(), theDistributionPackage.getDistributionCenter(), null, "hub", null, 1, 1, HubToDeparture.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getHubToDeparture_Depature(), theBasePackage.getTime(), null, "depature", null, 1, 1, HubToDeparture.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(hubToDurationEClass, HubToDuration.class, "HubToDuration", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getHubToDuration_Hub(), theDistributionPackage.getDistributionCenter(), null, "hub", null, 1, 1, HubToDuration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHubToDuration_Duration(), theXMLTypePackage.getInt(), "duration", "0", 1, 1, HubToDuration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
