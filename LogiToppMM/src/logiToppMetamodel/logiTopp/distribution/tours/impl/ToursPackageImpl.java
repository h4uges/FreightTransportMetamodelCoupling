...
public class ToursPackageImpl extends EPackageImpl implements ToursPackage {
	 ...
	 * @generated
	 */
	private EClass plannedDeliveryTourEClass = null;
	 ...
	 * @see logiToppMetamodel.logiTopp.distribution.tours.ToursPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static ToursPackage init() {
		...
		Object registeredToursPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ToursPackageImpl theToursPackage = registeredToursPackage instanceof ToursPackageImpl ? (ToursPackageImpl)registeredToursPackage : new ToursPackageImpl();
	 ...
	 */
	@Override
	public EClass getPlannedDeliveryTour() {
		return plannedDeliveryTourEClass;
	}
	 ...
	 */
	@Override
	public EReference getPlannedDeliveryTour_Stops() {
		return (EReference)plannedDeliveryTourEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getPlannedDeliveryTour_VehicleType() {
		return (EAttribute)plannedDeliveryTourEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getPlannedDeliveryTour_PlannedDuration() {
		return (EReference)plannedDeliveryTourEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getPlannedDeliveryTour_PlannedAt() {
		return (EReference)plannedDeliveryTourEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EReference getPlannedDeliveryTour_ExecutingCEPSP() {
		return (EReference)plannedDeliveryTourEClass.getEStructuralFeatures().get(4);
	}
	...
	public void createPackageContents() {
		...
		plannedDeliveryTourEClass = createEClass(PLANNED_DELIVERY_TOUR);
		createEReference(plannedDeliveryTourEClass, PLANNED_DELIVERY_TOUR__STOPS);
		createEAttribute(plannedDeliveryTourEClass, PLANNED_DELIVERY_TOUR__VEHICLE_TYPE);
		createEReference(plannedDeliveryTourEClass, PLANNED_DELIVERY_TOUR__PLANNED_DURATION);
		createEReference(plannedDeliveryTourEClass, PLANNED_DELIVERY_TOUR__PLANNED_AT);
		createEReference(plannedDeliveryTourEClass, PLANNED_DELIVERY_TOUR__EXECUTING_CEPSP);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(plannedDeliveryTourEClass, PlannedDeliveryTour.class, "PlannedDeliveryTour", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPlannedDeliveryTour_Stops(), theDeliveryPackage.getParcelActivity(), null, "stops", null, 0, -1, PlannedDeliveryTour.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPlannedDeliveryTour_VehicleType(), theFleetPackage.getVehicleType(), "vehicleType", "TRUCK", 1, 1, PlannedDeliveryTour.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPlannedDeliveryTour_PlannedDuration(), theBasePackage.getRelativeTime(), null, "plannedDuration", null, 1, 1, PlannedDeliveryTour.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPlannedDeliveryTour_PlannedAt(), theBasePackage.getTime(), null, "plannedAt", null, 1, 1, PlannedDeliveryTour.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPlannedDeliveryTour_ExecutingCEPSP(), theDistributionPackage.getCEPServiceProvider(), null, "executingCEPSP", null, 1, 1, PlannedDeliveryTour.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
