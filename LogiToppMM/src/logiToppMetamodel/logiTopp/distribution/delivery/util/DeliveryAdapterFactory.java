...
public class DeliveryAdapterFactory extends AdapterFactoryImpl {
	...
	protected DeliverySwitch<Adapter> modelSwitch =
		new DeliverySwitch<Adapter>() {
			@Override
			public Adapter caseParcelActivity(ParcelActivity object) {
				return createParcelActivityAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link logiToppMetamodel.logiTopp.distribution.delivery.ParcelActivity <em>Parcel Activity</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createParcelActivityAdapter() {
		return null;
	}
