/**
 */
package logiToppMetamodel.logiTopp.distribution.timetable.util;
...
public class TimetableAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link logiToppMetamodel.logiTopp.distribution.timetable.TimeTable <em>Time Table</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link logiToppMetamodel.logiTopp.distribution.timetable.Connection <em>Connection</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
