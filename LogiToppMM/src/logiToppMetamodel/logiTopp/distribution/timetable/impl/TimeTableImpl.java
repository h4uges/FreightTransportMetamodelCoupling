 ...
 * </p>
 * <ul>
 *   <li>{@link logiToppMetamodel.logiTopp.distribution.timetable.impl.TimeTableImpl#getConnections <em>Connections</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeTableImpl extends MinimalEObjectImpl.Container implements TimeTable {
	...
	protected EClass eStaticClass() {
		return TimetablePackage.Literals.TIME_TABLE;
	}
	...
	public EList<Connection> getConnections() {
		if (connections == null) {
			connections = new EObjectContainmentEList<Connection>(Connection.class, this, TimetablePackage.TIME_TABLE__CONNECTIONS);
		}
		return connections;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TimetablePackage.TIME_TABLE__CONNECTIONS:
