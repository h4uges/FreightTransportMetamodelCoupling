...
public class FleetFactoryImpl extends EFactoryImpl implements FleetFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case FleetPackage.DELIVERY_VEHICLE: return createDeliveryVehicle();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case FleetPackage.VEHICLE_TYPE:
	...
	public DeliveryVehicle createDeliveryVehicle() {
		DeliveryVehicleImpl deliveryVehicle = new DeliveryVehicleImpl();
