...
public class FleetAdapterFactory extends AdapterFactoryImpl {
	...
	protected FleetSwitch<Adapter> modelSwitch =
		new FleetSwitch<Adapter>() {
			@Override
			public Adapter caseFleet(Fleet object) {
				return createFleetAdapter();
			}
			@Override
			public Adapter caseDeliveryVehicle(DeliveryVehicle object) {
				return createDeliveryVehicleAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link logiToppMetamodel.logiTopp.distribution.fleet.Fleet <em>Fleet</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link logiToppMetamodel.logiTopp.distribution.fleet.DeliveryVehicle <em>Delivery Vehicle</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDeliveryVehicleAdapter() {
		return null;
	}
