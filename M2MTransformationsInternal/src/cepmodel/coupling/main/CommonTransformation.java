...
public class CommonTransformation {
	...
	private static void addShipmentRecords(String mainPath, String modelName) {
		CommonFreightTransportMetamodelRoot initialRoot = HandelModelService.loadCommonModelRoot(mainPath + modelName + "/transformation_steps/" + modelName + "_common_0.xmi");
		...
		HandelModelService.saveModel(initialRoot, mainPath + modelName + "/transformation_steps/" + modelName + "_common_1.xmi");
	}

	private static void splitTransportChains(String mainPath, String modelName) {
		CommonFreightTransportMetamodelRoot root = HandelModelService.loadCommonModelRoot(mainPath + modelName + "/transformation_steps/" + modelName + "_common_1.xmi");
		...
		HandelModelService.saveModel(root, mainPath + modelName + "/transformation_steps/" + modelName + "_common_2.xmi");
	}
	
	private static void toSingleDay(String mainPath, String modelName) {
		CommonFreightTransportMetamodelRoot root = HandelModelService.loadCommonModelRoot(mainPath + modelName + "/transformation_steps/" + modelName + "_common_2.xmi");
		...
		HandelModelService.saveModel(root, mainPath + modelName + "/transformation_steps/" + modelName + "_common_3.xmi");
	}
}
