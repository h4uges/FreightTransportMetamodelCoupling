...
public class LogiToppInputFileRegistry {
	...
	public List<String> depotLocationCSVs;
	...
	public static LogiToppInputFileRegistry createRegistry(String configFilePath)
			throws StreamReadException, DatabindException, IOException {
		ObjectMapper objectMapper = new ObjectMapper();
		LogiToppInputFileRegistry config = objectMapper.readValue(new File(configFilePath),
				LogiToppInputFileRegistry.class);
		return config;
	}
