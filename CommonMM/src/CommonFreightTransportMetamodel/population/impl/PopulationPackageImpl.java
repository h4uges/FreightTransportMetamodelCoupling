...
import CommonFreightTransportMetamodel.population.PopulationFactory;
import CommonFreightTransportMetamodel.population.PopulationPackage;
import CommonFreightTransportMetamodel.population.ShipmentConsumerProducer;
...
public class PopulationPackageImpl extends EPackageImpl implements PopulationPackage {
	 ...
	 * @see CommonFreightTransportMetamodel.population.PopulationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getHousehold_Member(), this.getPerson(), null, "member", null, 1, -1, Household.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
