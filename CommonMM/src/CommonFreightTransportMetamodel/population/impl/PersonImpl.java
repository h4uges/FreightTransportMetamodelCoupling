 ...
 * </p>
 * <ul>
 *   <li>{@link CommonFreightTransportMetamodel.population.impl.PersonImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PersonImpl extends ShipmentConsumerProducerImpl implements Person {
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PopulationPackage.PERSON__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PopulationPackage.PERSON__ID:
				return getId();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == HasId_.class) {
			switch (derivedFeatureID) {
				case PopulationPackage.PERSON__ID: return UtilsPackage.HAS_ID___ID;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == HasId_.class) {
			switch (baseFeatureID) {
				case UtilsPackage.HAS_ID___ID: return PopulationPackage.PERSON__ID;
				default: return -1;
			}
		}
