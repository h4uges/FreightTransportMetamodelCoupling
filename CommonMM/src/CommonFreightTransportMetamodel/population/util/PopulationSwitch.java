...
public class PopulationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PopulationPackage.BUSINESS_BRANCH: {
			...
			case PopulationPackage.SHIPMENT_CONSUMER_PRODUCER: {
			...
			case PopulationPackage.HOUSEHOLD: {
