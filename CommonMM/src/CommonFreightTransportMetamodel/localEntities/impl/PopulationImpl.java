 ...
 * </p>
 * <ul>
 *   <li>{@link CommonFreightTransportMetamodel.localEntities.impl.PopulationImpl#getHouseholds <em>Households</em>}</li>
 *   <li>{@link CommonFreightTransportMetamodel.localEntities.impl.PopulationImpl#getBusinesses <em>Businesses</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PopulationImpl extends MinimalEObjectImpl.Container implements Population {
	...
	protected EClass eStaticClass() {
		return LocalEntitiesPackage.Literals.POPULATION;
	}
	...
	public EList<Household> getHouseholds() {
		if (households == null) {
			households = new EObjectContainmentEList<Household>(Household.class, this, LocalEntitiesPackage.POPULATION__HOUSEHOLDS);
		}
		return households;
	}
	...
	public EList<Business> getBusinesses() {
		if (businesses == null) {
			businesses = new EObjectContainmentEList<Business>(Business.class, this, LocalEntitiesPackage.POPULATION__BUSINESSES);
		}
		return businesses;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LocalEntitiesPackage.POPULATION__HOUSEHOLDS:
				return ((InternalEList<?>)getHouseholds()).basicRemove(otherEnd, msgs);
			case LocalEntitiesPackage.POPULATION__BUSINESSES:
